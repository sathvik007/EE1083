...
\solution
Download \textbf{calc\_mul\_root.py} file from the \href{http://tlc.iith.ac.in/img/LA1400/calc_mul.py}{\url{http://tlc.iith.ac.in/img/LA1400/calc_mul.py}} and save it in directory where \textbf{mul.c} is saved.  Execute  \textbf{calc\_mul.py}.
